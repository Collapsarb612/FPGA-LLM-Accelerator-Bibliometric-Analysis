...
python src/00_init_query_config.py
if %errorlevel% neq 0 (
...
python src/01_import_raw_data.py
if %errorlevel% neq 0 (
...
python src/02_auto_data_clean.py
if %errorlevel% neq 0 (
...
python src/03_bibliometric_statistics.py
if %errorlevel% neq 0 (
...
python src/04_draw_knowledge_graphs.py
if %errorlevel% neq 0 (
...
python src/05_generate_final_report.py
if %errorlevel% neq 0 (
